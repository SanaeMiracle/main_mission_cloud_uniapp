 ...
 -->
      ...
      <view slot="actions" class="card-actions">
        ...
        <view
          ...
          <u--text size="14" text="获取评价码"> </u--text>
        </view>
    ...
    <u-modal
      ...
      <view class="slot-content">
        ...
        <!-- <u-upload :fileList="modal.img" @afterRead="afterRead" @delete="deletePic" name="file" :multiple="false"
          action="https://wj.api.cestech.com.cn:48002/mission_b/wx/WxApi/imgUpload" :maxCount="1" capture="camera"> -->
        <!-- <u-upload :file-list="fileList" @delete="deletePic" name="file" :multiple="false"
          action="https://wj.api.cestech.com.cn:48002/mission_b/wx/WxApi/imgUpload" :auto-upload="true" :maxCount="1"
...
export default {
  ...
  methods: {
    ...
    startSubmit() {
      // return
      uni.request({
        url: `https://wj.api.cestech.com.cn:48002/mission_b/v1/2/speechor/activity/start?id=${this.item.id}&img_url=${this.url_img}`,
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    acceptSubmit() {
      ...
      uni.request({
        url: `https://wj.api.cestech.com.cn:48002/mission_b/v1/2/speechor/activity/accept?id=${this.item.id}`,
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
