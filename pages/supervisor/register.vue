...
export default {
  ...
  onLoad(option) {
    ...
    if (scene != 'undefined') {
      ...
      this.communityId = uni.getStorageSync('community_id')
      this.getDetail()
      ...
      // uni.request({
      //   url: `https://wj.api.cestech.com.cn:48002/mission_b/xcx_api/bkbAppUser/addPoints?points=${this.points}&openid=${openid}`,
  ...
  methods: {
    getDetail() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/supervisor/dist/task/list',
        header: {
