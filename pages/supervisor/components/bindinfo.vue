...
<script>
import { supervisorbindinfo, community } from '@/common/api.js'
    ...
    detail: {
      handler: function (val) {
        if (val) {
          ...
          console.log(this.columns1, '小区数组2222')
          // this.columns.push(data)
          console.log(this.columns, '小区数组')
    ...
    submit() {
      if (
        ...
        uni.request({
          ...
          url: `https://wj.api.cestech.com.cn:48002/mission_b/v1/dudaoyuan/add?taskId=${this.ids}`,
          header: {
