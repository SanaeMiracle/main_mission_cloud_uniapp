  ...
  <view class="container">
    ...
    <view v-if="!pageLoading" style="background-color: #ffffff">
      <view>
        <view class="content u-p">
          <view class="u-flex u-row-between u-m-b">
            <u--text
              @click="toNext(detail)"
              align="right"
              :text="nextText"></u--text>
          </view>
          <u-line></u-line>
          <!-- <view class="titleBox text-xl text-black text-bold u-m-t">{{current.title||''}}</view> -->
          <view class="titleBox text-xl text-black text-bold u-m-t">{{
            detail.zs.title
          }}</view>
          <view class="u-m-t u-m-b">
            ...
            <u--text
              type="info"
              size="13"
              :text="detail.zs.createTime | dateFormat">
            </u--text>
          </view>
          <u-line></u-line>
          <!-- 中间文章区域 -->
        ...
        <question
          v-if="choiceqstShow"
          :question="detail.choiceqst"
          :details="detail.education_knowledge"
...
export default {
  ...
  methods: {
    ...
    add_points() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/user/add_points',
        header: {
    ...
    getDetail() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/cultura/listbycustomer2',
        header: {
          'X-Resource-Token': uni.getStorageSync('xtoken'),
        },
        data: {
