    ...
    <mescroll-body
      ...
      <view class="list" v-for="(item, index) in listData" :key="item.id">
        <view class="title">
          <view class="userinfo">
            <view class="avatar"
              ><u-avatar :src="item.headSculpture"></u-avatar
            ></view>
...
export default {
  ...
  methods: {
    ...
    handleDelete(e) {
      uni.request({
        url: `https://wj.api.cestech.com.cn:48002/mission_b/xcx_api/bkbPunchCardRecord/deleteRecord?id=${e.id}`,
        method: 'GET',
        success: res => {
          uni.showToast({
    ...
    upCallback(page) {
      ...
      this.phone = uni.getStorageSync('phone')
        ...
        : '123456789'
      uni.request({
        url: `https://wj.api.cestech.com.cn:48002/mission_b/mission/bkbPunchCardRecord/listOfCircles?pageNo=${page.num}&pageSize=10`,
        // data: {
