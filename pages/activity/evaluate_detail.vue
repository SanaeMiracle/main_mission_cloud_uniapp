	...
	export default {
		...
		methods: {
			...
			getDetail() {
				...
				// uni.request({
				//   url: `https://wj.api.cestech.com.cn:48002/mission_b/v1/2/activity/commentlist/id?id=${this.id}`,
				//   method: "GET",
				//   success: (res) => {
				...
				uni.request({
					url: `https://wj.api.cestech.com.cn:48002/mission_b/v1/2/speechor/activity/commentlist?id=${this.id}&pageNo=1&pageSize=10`,
					header: {
						'x-Resource-Token':uni.getStorageSync('xtoken'),
						//'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
					},
