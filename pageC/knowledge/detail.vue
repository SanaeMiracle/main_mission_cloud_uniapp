  ...
  <view class="container">
    ...
    <view
      ...
      <view class="u-m-t u-m-b">
        <u--text type="info" size="13" :text="detail.createTime | dateFormat">
        </u--text>
      </view>
...
export default {
  ...
  methods: {
    ...
    viewClick() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/viewclick',
        header: {
    ...
    getDetail() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/cultura/knowledge',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
