...
<script>
import { courseknowledgeread, knowledge } from '@/common/api.js'
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/2/cultura/id_list',
        header: {
    ...
    courseknowledgeread() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/theCourseIsLearningToSave',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
