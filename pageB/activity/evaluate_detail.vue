	...
	export default {
		...
		methods: {
			...
			getDetail() {
				...
				uni.request({
					url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingCourseReservation/selectResult`,
					header: {
					...
					method: "GET",
					success: (res) => {
						let url = 'https://wj.api.cestech.com.cn:48002/mission_b/sys/common/static/'
