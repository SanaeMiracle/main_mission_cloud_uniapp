    ...
    <view class="tip">
      ...
      <view class="tip-img"
        ><image
          ...
          mode="aspectFill"
          src="http://cdn.cestech.com.cn/TrainingProgram/img/75ccd8d4d97146048d10a48109a0117a.png"></image
      ></view>
    </view>
    <mescroll-body
      ref="mescrollRef"
          ...
          <view class="right">
            <view>
              ...
              <view class="labels">
                <span
                  class="tab"
                  v-if="item.speechLevel == '志愿者'"
                  style="
                    padding: 0 10rpx;
                    border-color: #3bcf99;
                    color: #3bcf99;
                  "
                  >{{ item.speechLevel }}</span
                >
                <span
                  class="tab"
                  v-if="item.speechLevel == '专家'"
                  style="
                    padding: 0 10rpx;
                    border-color: #ff861b;
                    color: #ff861b;
...
export default {
  ...
  methods: {
    ...
    upCallback(page) {
      console.log(page)
      uni.request({
        url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbAppointmentTeacher/list`,
        header: {
