  ...
  <view>
    ...
    <view class="introduce">
      <view class="introduce-info">
        ...
        <view class="img">
          <image
            src="http://cdn.cestech.com.cn/TrainingProgram/img/9f461c167d044fb587c9a58670c0882a.png"
            mode="scaleToFill"
        ...
        <view class="conetent">
          <view class="name"
            >活动名称：{{
              listData.bkbActivityCustomization.activityName
            }}</view
          >
          <view class="type"
            >活动类型：{{
              listData.bkbActivityCustomization.activityType
            }}</view
          >
        </view>
      </view>
    ...
    <view class="myBtn" @click="yuyue"> 预约 </view>
    <u-popup
      :show="show"
      mode="center"
      @close="close"
        ...
        uni.showModal({
          ...
          success: res => {
            ...
            if (res.confirm) {
              ...
              uni.request({
                url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbActivityCustomization/activityPerson`,
                header: {
                  'x-Resource-Token': uni.getStorageSync('xtoken'),
                },
                data: {
