  ...
  <view>
    <view class="mian">
      <view class="img" v-if="detail.titleUrl">
        <!-- 	<image src="http://cdn.cestech.com.cn/BkpKnowledge/img/87365097fa96463c8790dc4074fe93d1.png"
...
export default {
  ...
  methods: {
    submit() {
      ...
      // let myLength = arr.length + this.inputArr.length
      // console.log(myLength, this.questionList.length);
      ...
      if (
        ...
        uni.request({
          url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbAnswersQuestionnaire/addSubmit?id=${
            this.wjid
    ...
    answerREQInput(value) {
      ...
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbAnswersQuestionnaire/add',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    course(id) {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbQuestionnaireQuestionsSon/list',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    answer(id) {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbQuestionnaireQuestions/queryById',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    topic(id) {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbQuestionnaireQuestions/list',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    ck_query(id) {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbQuestionnaireInquiry/queryById',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
    ...
    getQuestions(id) {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbQuestionnaireQuestions/queryQuestionGroups',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
