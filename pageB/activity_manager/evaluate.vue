...
<script>
	...
	export default {
		...
		methods: {
			...
			getDetail() {
				uni.request({
					url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingTask/activityLookS`,
					header: {
			...
			queryList(page, list_rows) {
				...
				uni.request({
					url: `https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingTask/activityLookX`,
					header: {
						'x-Resource-Token':uni.getStorageSync('xtoken'),
						//'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
					},
