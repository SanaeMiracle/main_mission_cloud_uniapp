    ...
    <mescroll-body
        ...
        <view
          ...
          <view class="right">
            <view>
              ...
              <view class="simple">预约时间：{{ item.appointeeTime }}</view>
            </view>
            <view></view>
          </view>
        </view>
      ...
      <view class="list" v-if="jb === 0">
        <view
          class="list-li"
          v-for="item in lists"
          @click="detail_s(item.bkbActivityCustomization.id)">
          <view class="left">
            <image
              :src="item.bkbActivityCustomization.coverUrl"
              mode="aspectFill"
              style="width: 100%; height: 100%">
            </image>
          </view>
          <view class="right">
            <view>
              ...
              <view class="code">订单状态:&ensp;{{ item.status }}</view>
              <view class="simple">预约时间：{{ item.time }}</view>
            </view>
            <view></view>
          </view>
        </view>
...
export default {
  ...
  data() {
    return {
      ...
      bese_url:
        'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingProgram/list1',
      // bese_url:'http://192.168.100.12:8087/mission_b/wx/bkbTrainingProgram/list1',
      list: [],
      lists: [],
      myList: [],
      jb: 0,
  ...
  methods: {
    click(item) {
      ...
      console.log(this.jb)
      if (this.jb === 0) {
        // this.bese_url='http://192.168.100.12:8087/mission_b/wx/bkbTrainingProgram/list1'
        this.bese_url =
          'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingProgram/list1'

        // this.downCallback();
      } else {
        // this.bese_url='https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingProgram/list'
        this.bese_url =
          'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingProgram/list'
        // this.bese_url='http://192.168.100.10:8087/mission_b/wx/bkbTrainingProgram/list'
      ...
      uni.request({
        ...
        success: res => {
          ...
          if (res.data.code === 200) {
            ...
            if (this.jb === 1) {
              console.log(
                res.data.result.records.bkbTeacherManagementPeople,
                'cc'
              )

              // if(this.bese_url='https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingProgram/list'){
