...
export const activityPerson = (params = {}) => mainRequest.get('/mission_b/wx/bkbActivityCustomization/activityPerson', params); //获取积分
export const imgUpload = (params = {}) => mainRequest.post('/mission_b/wx/WxApi/imgUpload', params); //拍照打卡