      ...
      <view v-if="searchShow">
        <view
          ...
          <view class="shop-list-right">
            ...
            <view class="shop-potions"
              ><text class="num">{{ item.points }}</text> 积分</view
            >
          </view>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    search_for() {
      ...
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/p/order/selectAll',
        header: {
