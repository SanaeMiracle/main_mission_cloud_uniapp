	...
	export default {
		...
		methods: {
			...
			address_detail() {
				...
				uni.request({
					url: `https://wj.api.cestech.com.cn:48002/mission_b/p/address/addrInfo?addrId=${this.ids}`,
					header: {
						'x-Resource-Token':uni.getStorageSync('xtoken'),
						//'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
					},
					// url: `https://wj.api.cestech.com.cn:48002/mission_b/p/address/addrInfo?addrId=${this.ids}&userId=${userId}`,
					// header: {
			...
			onSaveAddr: function() {
				...
				if (ths.receiver && ths.mobile && ths.addr) {
					uni.request({
						url: 'https://wj.api.cestech.com.cn:48002/mission_b/p/address/addAddr',
						header: {
							'x-Resource-Token':uni.getStorageSync('xtoken'),
							//'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
						},
			...
			modifyAddr() {
				...
				let beforePage = pages[pages.length - 2];
				uni.request({
					url: 'https://wj.api.cestech.com.cn:48002/mission_b/p/address/updateAddr',
					header: {
						'x-Resource-Token':uni.getStorageSync('xtoken'),
						//'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
					},
