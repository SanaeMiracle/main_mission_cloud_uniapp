<template>
  <view>
    <view class="tips">
      ...
      <image
        src="http://cdn.cestech.com.cn/BkpKnowledge/img/973b30b909df4d99a948018c87212501.jpg"
        mode="widthFix"></image>
    </view>
    <view class="top">
      <view class="titleA">
        ...
        <view v-for="(item, index) in 21" :key="index">
          <view class="isCheck" v-if="index < checkDays && index != 20">
            <view class="day">
              ...
              <image
                src="https://oms.cestech.com.cn/BkpKnowledge/img/9ba730e59dd4459ba35753adee24b06f/gou.png"
                mode=""></image>
            </view>
          </view>
          <view class="noCheck" v-if="index >= checkDays && index != 20">
            <view class="day">
              <view class="title"> 第{{ index + 1 }}天 </view>
              <image
                src="https://oms.cestech.com.cn/BkpKnowledge/img/85e3c0dd876c499c8efc85e111605fd3/gouNo.png"
                mode=""></image>
            </view>
          </view>
      ...
      <view class="bottom">
        ...
        <view class="btn" v-else> 今日已打卡 </view>
      </view>
    </view>
  </view>
</template>
...
export default {
  ...
  methods: {
    continuousClockingRecord() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/xcx_api/bkbContinuousClockingRecord/list',
        data: {
    ...
    getIsCheck() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/xcx_api/bkbPunchCardRecord/selectRecord',
        data: {
          phone: uni.getStorageSync('phone'),
        },
        header: {
        ...
        method: 'GET',
        success: res => {
          this.isCheck = res.data.result == 'NO' ? true : false
        },
      })
    },
    ...
    toCheck() {
      uni.redirectTo({
        url: '/pageD/check/check?title=21天打卡&id=1656547545604911105',
      })
    },
  },
}
