...
export default {
  ...
  methods: {
    getDetail() {
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingCourseReservation/answer',
        header: {
      ...
      // uni.request({
      // 	url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/course/choiceqst',
      // 	data: {
      // 		id: this.id
      // 	},
      // 	method: "GET",
    ...
    handleSuccess({ answer }) {
      ...
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/v1/course/save_answer',
        header: {
          'x-Resource-Token': uni.getStorageSync('xtoken'),
          //'x-Resource-Token':uni.getStorageSync('xtoken'), //自定义请求头信息
        },
