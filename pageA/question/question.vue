        ...
        <view v-if="hasData">
          <view class="u-flex u-row-between">
            ...
            <u--text
              type="info"
              align="right"
              :text="questioncp[0][num].choiceType == 0 ? '单选题' : '多选题'">
            </u--text>
          </view>
          ...
          <view
            ...
            <view
              class="mentalList"
              v-for="(item, index) in questioncp[0][num].answer"
          ...
          <u-tabbar
            ...
            <view
              class="btns u-flex"
              :class="{
                'u-row-right': num != questioncp[0].length,
                'u-row-between': num != 0,
              }">
              ...
              <view
                class="btn"
                v-if="num + 1 != questioncp[0].length"
                @click="toNext"
...
export default {
  ...
  methods: {
    Toggle(info, index) {
      ...
      option.forEach((item, index) => {
        if (item.id == info.id) {
          ...
          this.$set(
            this.questioncp[0][this.num].answer[index],
            'checked',
            !checked
          )
        } else if (questioncp.choiceType == 0) {
    ...
    toEnd() {
      ...
      uni.request({
        url: 'https://wj.api.cestech.com.cn:48002/mission_b/wx/bkbTrainingCourseReservation/submit',
        header: {
